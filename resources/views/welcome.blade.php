        ...
        <div class="border-t border-b flex items-center justify-between px-5 py-1">
            ...
            @if (Route::has('login'))
                <div class="login-section flex items-center">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="text-white hover:text-gray-900 font-semibold transition duration-300 focus:outline-none focus:ring focus:border-blue-300">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="text-white hover:text-gray-900 font-semibold transition duration-300 focus:outline-none focus:ring focus:border-blue-300 ml-4">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="text-white hover:text-gray-900 font-semibold transition duration-300 focus:outline-none focus:ring focus:border-blue-300 ml-4">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
